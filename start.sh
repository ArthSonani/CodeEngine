...
kubectl exec deploy/kafka -- /opt/kafka/bin/kafka-topics.sh --create --topic code-submissions --partitions 10 --replication-factor 1 --bootstrap-server localhost:9092 --if-not-exists
...
kubectl exec deploy/kafka -- /opt/kafka/bin/kafka-consumer-groups.sh --bootstrap-server localhost:9092 --group isolate-workers --reset-offsets --to-latest --execute --topic code-submissions
